    ...
    <div class="flex h-screen pt-16 overflow-hidden">
            ...
            <div class="px-8 py-6">
                ...
                <div class="grid grid-cols-2 gap-x-12 gap-y-2 mb-6 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 font-medium">{{ $ticket->created_at->format('m/d/Y h:i:s A') }}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 font-medium">{{ $ticket->updated_at->format('m/d/Y h:i:s A') }}</span>
                    </div>
                </div>
                ...
                @php
                    ...
                    $progressWidth = $progressMap[$ticket->status] ?? '0%';
                ...
                <div class="relative w-full h-2 bg-gray-200 rounded-full mb-6">
                    <div class="absolute top-0 left-0 h-2 bg-gray-900 rounded-full" style="width: {{ $progressWidth }};">
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div
                        class="w-full bg-gray-50 rounded-lg p-4 min-h-[150px] border border-gray-200 text-sm whitespace-pre-wrap">
                        {{ $ticket->description }}
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-gray-900">{{ $ticket->assignee->name ?? 'Unassigned' }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="w-1/3 h-full flex flex-col border-l border-gray-200 bg-gray-50">
            ...
            <div class="flex-1 overflow-y-auto p-4 custom-scrollbar">
                ...
                <!-- Note Input -->
                <form action="{{ route('user.ticket.note', $ticket->ticketID) }}" method="POST"
